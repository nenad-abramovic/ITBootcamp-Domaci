...
var textBoxTitle = document.querySelector('#txt-title');
...
function addItem() {
  var txtBox = document.querySelector('#txt-title');
  console.log(txtBox);
...
function removeTask(e) {
  ...
  var divToRemove = btnToRemove.parentElement.parentElement;
...
function handleCheckChange(e) {
  ...
  if (chkBox.checked) {
    ...
    var _checkContainer = chkBox.parentElement;
    var _itemContainer = _checkContainer.parentElement;
    _itemContainer.children[0].style.textDecoration = 'none';
  }
}
